...
type CreateOrderRequest struct {
	...
	CustomerId    int32                  `protobuf:"varint,1,opt,name=customer_id,json=customerId,proto3" json:"customer_id,omitempty"` // Corrigido: "costumer_id" → "customer_id"
...
const file_order_order_proto_rawDesc = "" +
	...
	"\x05Order\x123\n" +
	"\x06Create\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponseB>Z<github.com/joseguilherme-fs/microservices-proto/golang/orderb\x06proto3"
